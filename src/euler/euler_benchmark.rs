...
pub fn benchmark() -> () {
    ...
    println!(
        "Problem 1 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 2 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 3 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 4 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 5 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 6 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 7 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 8 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 9 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 10 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 11 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 12 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 13 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 14 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 15 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 16 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 17 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 18 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 19 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 20 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 21 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 22 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer.unwrap()
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 23 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 24 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 25 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 26 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 27 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 28 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 29 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 30 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 31 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 32 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 33 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 34 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 35 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 36 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 37 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 38 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 39 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 40 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 41 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 42 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer.unwrap()
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 43 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 44 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 45 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 46 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 47 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 48 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 49 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 50 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 52 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 53 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 57 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 58 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 65 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
    ...
    let end_t = timer.elapsed().unwrap().as_millis();
    println!(
        "Problem 67 took {} milli-seconds, and its answer is {}",
        end_t - begin_t,
        answer
    );
}
